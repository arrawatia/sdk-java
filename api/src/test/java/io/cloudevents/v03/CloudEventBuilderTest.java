...
public class CloudEventBuilderTest {
	...
	public void should_have_datacontenttype() {
		...
		assertEquals(expected, ce.getDatacontenttype().get());
	}
	...
	public void should_have_datacontentencoding() {
		...
		CloudEvent<Object> ce =
				new CloudEventBuilder<>()
						...
						.withDatacontentencoding(expected)
						.build();

		// assert
		assertTrue(ce.getDatacontentencoding().isPresent());
		assertEquals(expected, ce.getDatacontentencoding().get());
	}
